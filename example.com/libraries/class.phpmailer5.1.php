...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = "no-reply@bluservice.it"; //= 'root@localhost';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = "Bluservice"; //= 'Root User';
   ...
   * @var string
   */
  public $Sender             = "no-reply@bluservice.it"; //= '';
  ...
  */
  ...
  private function EncodeFile($path, $encoding = 'base64') {
    try {
      ...
      if(!filesize($path)){
		  $this->SetError(sprintf("File Size:  %s", filesize($path)));
		  return false;
	  }
      #
